...
There are couple of algorithms to build a decision tree:
...
In order to identify the best attribute for ID3 classification trees, we use the "Information gain" criteria.  Information gain (IG) measures how much "information" a feature gives us about the class. Decision trees always try to maximize the Information gain. So an attribute with highest Information gain will be tested/split first.
